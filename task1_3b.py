...
driver.find_element_by_name("identifier").send_keys("george.george5000@gmail.com")  # gmail 
...
time.sleep(2)
driver.find_element_by_name("password").send_keys("Ojbeinaidasdd@!")           # password
